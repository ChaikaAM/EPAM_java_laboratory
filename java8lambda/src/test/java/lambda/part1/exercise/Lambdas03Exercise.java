...
public class Lambdas03Exercise {
    ...
    public void generic0() {
        final GenericProduct<Integer> prod = new GenericProduct<Integer>() {
            @Override
            public Integer prod(final Integer a, final int i) {
                return a * i;
            }
        }; // Use anonymous class
    ...
    public void generic1() {
        final GenericProduct<Integer> prod = (a, i) -> { return a * i; }; // Use statement lambda
    ...
    @Test
    public void strSum2() {
        final GenericProduct<String> prod =  (a, i) -> stringSumWithDelimeter(a, i); // use stringSumWithDelimeter;
